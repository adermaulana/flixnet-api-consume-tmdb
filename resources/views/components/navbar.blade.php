<nav class="bg-gray-950 sticky top-0 z-50">
    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex flex-shrink-0 items-center">
          <h1 style="color:#e50914" class="text-3xl font-bold">FLIXNET</h1>
        </div>
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <x-nav-link :active="request()->routeIs('home')" href="{{ route('home') }}">Home</x-nav-link>
            <x-nav-link :active="request()->routeIs('movies')" href="{{ route('movies') }}">Movies</x-nav-link>
            <x-nav-link :active="request()->routeIs('trending')" href="{{ route('trending') }}">New & Trending</x-nav-link>
            <x-nav-link :active="request()->routeIs('my-list')" href="{{ route('my-list') }}">My List</x-nav-link>
          </div>
        </div>
      </div>
